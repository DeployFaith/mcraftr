      ...
      <div className="p-5 space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          {invOpen && (invLoading ? (
            ...
            <div className={selectedSlot ? 'grid gap-3 lg:w-fit lg:max-w-full lg:grid-cols-[max-content_18rem] lg:items-start lg:justify-start' : 'space-y-3'}>
              <div className="space-y-3 lg:min-w-[23rem] lg:max-w-full">
                {selectedSlot && (
              ...
              {selectedSlot && (
                <div className="w-full rounded-[24px] border border-[var(--accent-mid)] bg-[linear-gradient(180deg,rgba(82,190,255,0.14),rgba(8,11,16,0.94))] p-3 shadow-[0_18px_42px_rgba(0,0,0,0.28)] lg:w-72">
